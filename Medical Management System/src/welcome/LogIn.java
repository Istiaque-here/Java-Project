...
public class LogIn extends JFrame
{
    ...
    LogIn()
    {
        ...
        path_s = "C:\\Users\\Istiaque Khalique\\Documents\\Java Project Images\\lb.png";
        ic = new ImageIcon(new ImageIcon(path_s).getImage().getScaledInstance(80, 35, Image.SCALE_SMOOTH));
        b2 = new JButton(ic);
