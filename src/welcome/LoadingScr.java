...
public class LoadingScr extends JFrame
{
    ...
    public LoadingScr()
    {
        ...
        //ip = "C:\\Users\\Istiaque Khalique\\Documents\\Medical Management System\\src\\images\\wpi.jpeg";
        ic = new ImageIcon(new ImageIcon(getClass().getResource("/images/wpi.jpeg")).getImage().getScaledInstance(500, 380, Image.SCALE_SMOOTH));
        lb = new JLabel(ic);
